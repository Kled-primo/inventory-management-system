        ...
        <tbody>
            ...
            <tr>
                <td class="align-middle">
                    ...
                    <select wire:model.live="invoiceProducts.{{$index}}.product_id" id="invoiceProducts[{{$index}}][product_id]" class="form-control text-center @error('invoiceProducts.' . $index . '.product_id') is-invalid @enderror">
                ...
                <td class="align-middle text-center">
                    @if($invoiceProduct['is_saved'])
                    {{ $unit_cost = number_format($invoiceProduct['purchase_price'], 2) }}
                ...
                {{--- Total ---}}
                <td class="align-middle text-center">
                    {{ $product_total = $invoiceProduct['purchase_price'] * $invoiceProduct['quantity'] }}
